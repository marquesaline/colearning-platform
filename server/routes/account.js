...
router.get('/:userId/editar-agenda', controllerAgenda.editAgenda)
router.put('/:userId/editar-agenda', controllerAgenda.updateAgenda)
router.get('/:userId/apagar-agenda', controllerAgenda.removeAgenda)
router.delete('/:userId/apagar-agenda', controllerAgenda.deleteAgenda)
